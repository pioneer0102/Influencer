...
function SignInPage() {
  ...
  return (
    <div className="flex flex-col items-center sm:justify-center md:justify-center flex-1 min-w-0">
      <Paper className="flex flex-col items-center h-100 md:items-center py-8 px-16 sm:p-48 md:p-64 sm:rounded-2xl md:rounded-none sm:shadow md:shadow-none ltr:border-r-1 rtl:border-l-1">
        <div className="w-full max-w-320 sm:w-320 mx-auto sm:mx-0">
          ...
          <div className="flex mt-24 font-medium">
            ...
            <Link className="ml-8" to="/sign-up">
              Sign up
            </Link>
          </div>
        </div>
